        ...
        <div className='footer-con'>
          <div className='flex flex-col justify-center items-center'>
            <ul className='flex flex-col items-center gap-y-10 md:gap-y-16'>
              <li><Link to="#" className='text-5xl md:text-6xl xl:text-7xl 2xl:text-8xl text-slate-500 hover:text-white' onClick={(e) => onHandleTop(e, 1)}>My Work</Link></li>
              <li><Link to="#" className='text-5xl md:text-6xl xl:text-7xl 2xl:text-8xl text-slate-500 hover:text-white' onClick={(e) => onHandleTop(e, 2)}>My Skill</Link></li>
              <li><Link to="#" className='text-5xl md:text-6xl xl:text-7xl 2xl:text-8xl text-slate-500 hover:text-white' onClick={(e) => onHandleTop(e, 3)}>About Me</Link></li>
            </ul>  
