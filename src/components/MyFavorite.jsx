    ...
    return (
        <div ref={sectionRef} id="scroll-section-4" className='app__scroll-section'>
            ...
            <div className='app__message-text size-1/2 text-6xl text-slate-700'>
                ...
                <p className='app__sticky-elem message-text-e text-8xl 2xl:text-9xl xl:ml-10 2xl:ml-20 text-center' data-opacity-in='[0, 1, { "start": "0.82", "end": "0.87" }]' data-translatey-in='[10, 0, { "start": "0.82", "end": "0.87" }]' data-opacity-out='[1, 0, { "start": "0.93", "end": "0.99" }]' data-translatey-out='[0, -10, { "start": "0.93", "end": "0.99" }]'>마무리 하는 보통의<br className='xl:hidden' /> 하루가 더 좋다!</p>
            </div>  
