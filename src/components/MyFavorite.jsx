    ...
    return (
        <section ref={sectionRef} id="scroll-section-4" className='app__scroll-section' data-background-color='["fff", "ffc800", "0074d9", "ff851b", "ffd14d", "fff"]' style={{backgroundColor: '#fff'}}>
            ...
            <div className='app__message-text size-full text-6xl text-slate-50'>
                <p className='app__sticky-elem message-text-a text-6xl sm:text-7xl md:text-8xl 2xl:text-9xl font-semibold md:ml-20 2xl:ml-20' data-opacity-in='[0, 1, { "start": "0.05", "end": "0.1" }]' data-translatey-in='[10, 0, { "start": "0.05", "end": "0.1" }]' data-opacity-out='[1, 0, { "start": "0.18", "end": "0.28" }]' data-translatey-out='[0, -10, { "start": "0.18", "end": "0.28" }]'>나는 음악을 듣는 걸<br className='hidden md:block' /> 좋아하고</p>
