...
export default function TopVisual({type, heightNum}) {
    ...
    return (
        <section ref={sectionRef} id="scroll-section-0" className='app__scroll-section'>
            ...
            <div className="app__main-message !left-1/2 !-translate-x-1/2 !-translate-y-1/2 text-5xl md:text-7xl xl:text-8xl 2xl:text-9xl">
                ...
                <div className="app__mask flex-none message-tit-b" data-opacity-out='[1, 0, { "start": "0.37", "end": "0.47" }]' data-translatey-out='[0, -500, { "start": "0.37", "end": "0.47" }]'>
                    <p className="app__message-tit" data-effect="slide-right" data-delay="0.1s">c</p>
                </div>
                <div className="app__mask flex-none message-tit-c" data-opacity-out='[1, 0, { "start": "0.35", "end": "0.45" }]' data-translatey-out='[0, -500, { "start": "0.35", "end": "0.45" }]'>
                    <p className="app__message-tit" data-effect="slide-right" data-delay="0.2s">r</p>
                </div>
                <div className="app__mask flex-none message-tit-d" data-opacity-out='[1, 0, { "start": "0.33", "end": "0.43" }]' data-translatey-out='[0, -500, { "start": "0.33", "end": "0.43" }]'>
                    <p className="app__message-tit" data-effect="slide-right" data-delay="0.3s">o</p>
                </div>
                <div className="app__mask flex-none message-tit-e" data-opacity-out='[1, 0, { "start": "0.31", "end": "0.41" }]' data-translatey-out='[0, -500, { "start": "0.31", "end": "0.41" }]'>
                    <p className="app__message-tit" data-effect="slide-right" data-delay="0.4s">l</p>
                </div>
                <div className="app__mask flex-none message-tit-f" data-opacity-out='[1, 0, { "start": "0.29", "end": "0.39" }]' data-translatey-out='[0, -500, { "start": "0.29", "end": "0.39" }]'>
                    <p className="app__message-tit" data-effect="slide-right" data-delay="0.5s">l</p>
                </div>
                <div className="app__mask flex-none" data-effect>&nbsp;</div>
                <div className="app__mask flex-none message-tit-g" data-opacity-out='[1, 0, { "start": "0.27", "end": "0.37" }]' data-translatey-out='[0, -500, { "start": "0.27", "end": "0.37" }]'>
                    <p className="app__message-tit" data-effect="slide-right" data-delay="0.6s">T</p>
                </div>
                <div className="app__mask flex-none message-tit-h" data-opacity-out='[1, 0, { "start": "0.25", "end": "0.35" }]' data-translatey-out='[0, -500, { "start": "0.25", "end": "0.35" }]'>
                    <p className="app__message-tit" data-effect="slide-right" data-delay="0.7s">o</p>
                </div>
                <div className="app__mask flex-none" data-effect>&nbsp;</div>
                <div className="app__mask flex-none message-tit-i" data-opacity-out='[1, 0, { "start": "0.23", "end": "0.33" }]' data-translatey-out='[0, -500, { "start": "0.23", "end": "0.33" }]'>
                    <p className="app__message-tit" data-effect="slide-right" data-delay="0.8s">S</p>
                </div>
                <div className="app__mask flex-none message-tit-j" data-opacity-out='[1, 0, { "start": "0.21", "end": "0.31" }]' data-translatey-out='[0, -500, { "start": "0.21", "end": "0.31" }]'>
                    <p className="app__message-tit" data-effect="slide-right" data-delay="0.9s">e</p>
                </div>
                <div className="app__mask flex-none message-tit-k" data-opacity-out='[1, 0, { "start": "0.19", "end": "0.29" }]' data-translatey-out='[0, -500, { "start": "0.19", "end": "0.29" }]'>
                    <p className="app__message-tit" data-effect="slide-right" data-delay="1s">e</p>
                </div>
                <div className="app__mask flex-none" data-effect>&nbsp;</div>
